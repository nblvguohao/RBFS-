...
#@Time:2022/3/4 10:31
#@Author:lvguohao
#@File:getEssentialProtein_MBD.py
#@software:PyCharm
#-*- codeing=utf-8 -*-
...
def getEssentialProteinNumber(parent_path,times):
    path = os.path.join(r'C:\Users\123\Desktop\lvguohao\data\dataset\finalPPIWeight_MBD.xlsx')
    ...
    # 第n（n > 1）次读取蛋白质已有的得分
    path2 = os.path.join(parent_path, r'C:\Users\123\Desktop\lvguohao\data\dataset\lastProteinScore_MBD.xlsx')
    data2 = pd.read_excel(path2)
    exist_protein_score = (np.array(data2)).tolist()
    # print('exist_protein_score长度:', exist_protein_score.__len__())

    # 第1次读取蛋白质已有的得分
    path3 = os.path.join(parent_path, r'C:\Users\123\Desktop\lvguohao\data\dataset\eachProteinDomainWeight_MBD.xlsx')
    ...
    # 把上一阶段排序的蛋白质得分记录下来
    workbook = xlsxwriter.Workbook('C:\\Users\\123\Desktop\\lvguohao\\data\\dataset\\lastProteinScore_MBD.xlsx')
